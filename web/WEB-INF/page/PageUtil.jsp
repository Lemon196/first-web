...
<a class="layui-btn" href="${pageContext.request.contextPath }${Map.url}${Map.pageNumber-1>0?Map.pageNumber-1:1}">上一页</a>
<a class="layui-btn" href="${pageContext.request.contextPath }${Map.url}${Map.pageNumber+1>Map.tatalPage?Map.tatalPage:Map.pageNumber+1}">下一页</a>
<a class="layui-btn" href="${pageContext.request.contextPath }${Map.url}${Map.tatalPage}">尾页</a>
&nbsp;&nbsp;共<b>${Map.tatalPage}</b>页 &nbsp;&nbsp;

<select id="jumpNumber">
    <c:forEach begin="1" varStatus="num" end="${Map.tatalPage}">
